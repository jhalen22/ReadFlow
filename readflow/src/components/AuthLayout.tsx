...
export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen grid md:grid-cols-[38%_62%] bg-white">
      <div className="hidden md:flex flex-col justify-between bg-ink-900 px-12 py-16 text-center">
        <div className="mt-16">
        ...
        <Link
        to={backTo}
        className="inline-flex items-center justify-center gap-2 text-base font-medium text-slate-200 hover:text-white transition-colors self-center"
       >
          <ArrowLeft size={20} />
          <span>{backLabel}</span>
        </Link>
      ...
      <div className="flex md:hidden items-center justify-between bg-ink-900 px-6 py-5">
        ...
        <Link to={backTo} className="inline-flex items-center gap-1 text-sm text-slate-200 hover:text-white">
          <ArrowLeft size={16} />
          {backLabel}
        </Link>
      </div>
